...
#define PWM_DEFAULT_CONFIG_OUT3_PIN 11
#endif
...
#define PWM_DEFAULT_CONFIG_TOP_VALUE (160000000/50000/2)
#endif
...
// disabled retargeting to uart as we want to send over BLE (nordic uart service)
