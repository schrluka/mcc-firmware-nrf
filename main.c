...
static void ble_evt_dispatch(ble_evt_t * p_ble_evt)
{
    ...
    bat_event(p_ble_evt);
    mcs_on_ble_evt(p_ble_evt);  // our dedicated model car service
...
{
    hw_dis_pwm();   // turn of watchdog as a safety precaution
    ...
    for (;;)
    {
        ...
        if (tick != last_tick) {
            ...
            if (u_bat < 2900) {
                ...
                if (lococo_get_bat_stop() && (!hw_get_reed())) {
